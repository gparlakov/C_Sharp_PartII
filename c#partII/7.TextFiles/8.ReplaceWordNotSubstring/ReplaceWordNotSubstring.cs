...
{
    public class ReplaceWordNotSubstring
    {
        //
        //Summary:        
        ...
        public static string ReplaceWord(string str, string word, string replacemetWord)
        {
            ...
            do
            {
                ...
                before = IfInsideReturnSymbol(str,indexEnd - 1);
                after = IfInsideReturnSymbol(str,indexEnd + word.Length);
